...
export async function GET() {
  const content = `# ElitPOS by Elitjohns Digital Agency — Full Product Information
...
ElitPOS is a multi-tenant SaaS business management system built by Elitjohns Digital Agency, supporting five business types: retail, restaurant, supermarket, auto service, and vehicle dealership. Built with modern web technology, it provides a complete suite of business tools in a single platform with real-time synchronization and AI-powered insights.
...
Website: https://elitpos.elitjohnsdigital.co.ke
...
1. **Register**: Create a free account at https://elitpos.elitjohnsdigital.co.ke/register — no credit card needed
...
|------|-------------|-----|
| Retail | Stores, shops, boutiques | https://elitpos.elitjohnsdigital.co.ke/retail |
| Restaurant | Cafes, restaurants, food service | https://elitpos.elitjohnsdigital.co.ke/restaurant |
| Supermarket | Grocery, departments, high-volume | https://elitpos.elitjohnsdigital.co.ke/supermarket |
| Auto Service | Workshops, garages, service centers | https://elitpos.elitjohnsdigital.co.ke/auto-service |
| Dealership | Vehicle sales, showrooms | https://elitpos.elitjohnsdigital.co.ke/dealership |

## Contact

- Website: https://elitpos.elitjohnsdigital.co.ke
- Support: info@elitjohnsdigital.co.ke
- About: https://elitpos.elitjohnsdigital.co.ke/about
- Contact form: https://elitpos.elitjohnsdigital.co.ke/contact

## Legal

- Privacy Policy: https://elitpos.elitjohnsdigital.co.ke/privacy
- Terms of Service: https://elitpos.elitjohnsdigital.co.ke/terms
`
